...
```bash
git remote add encore encore://schema-markup-generator-5pii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/schema-markup-generator-5pii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/schema-markup-generator-5pii/settings/integrations/github)
